...
invoiceRouter
   ...
   */
  .post(
    validationSchema(invoiceStoreSchema, ["body"]),
...
invoiceRouter
   ...
   */
  .get(
    validationSchema(invoiceShowSchema, ["params"]),
  ...
  .patch(
    validationSchema(
      updateSchema(paramIdSchema, invoiceUpdateSchema),
      ["body", "params"],
      "update"
    ),
   ...
   */
  .delete(
    validationSchema(invoiceDestroySchema, ["params"]),
...
invoiceRouter
   ...
   */
  .get(
    validationSchema(invoiceShowCustomerSchema, ["params"]),
    InvoiceController.show("Customer")
  );
